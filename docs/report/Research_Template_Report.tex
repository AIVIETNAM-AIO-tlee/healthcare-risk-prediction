...
\input{sections/research_summary}
...
\input{sections/model_related_work}


\section{Methodology and Research Architecture}
\label{sec:methodology}
\input{sections/methodology_architecture}
...
\input{sections/model_experimental_design}
\input{sections/model_shap_methodology}

\section{Results and Discussion}
\label{sec:results}
\input{sections/model_results_discussion}
...
\item \textbf{GitHub Repository:} \url{https://github.com/AIVIETNAM-AIO-tlee/healthcare-risk-prediction}
\item \textbf{Dataset:}
\begin{itemize}
    \item Dataset 1 -- Personal Key Indicators of Heart Disease (2022):
    \href{https://www.kaggle.com/datasets/kamilpytlak/personal-key-indicators-of-heart-disease}{Kaggle source}.
    \item Dataset 2 -- Heart Failure Prediction:
    \href{https://www.kaggle.com/datasets/fedesoriano/heart-failure-prediction}{Kaggle source}.
    \item Dataset 3 -- Heart Disease Health Indicators (BRFSS 2015):
    \href{https://www.kaggle.com/datasets/alexteboul/heart-disease-health-indicators-dataset}{Kaggle source}.
    \item The downloaded raw files used by this project are stored under
    \texttt{data/raw/}. Users should review the original dataset pages for
    licensing, attribution, and usage conditions before redistribution.
\end{itemize}
\item \textbf{Demo Video / Presentation:}
\begin{itemize}
    \item Link demo video: \href{https://www.youtube.com/watch?v=iwFmqRy-ldU}{Link demo}
    \item Link slide presentation: \href{https://drive.google.com/file/d/19ftotvEal-7DuOh9jbJ-8TdZjnsm8Tqi/view?usp=sharing}{Link slide presentation}
\end{itemize}
\end{enumerate}
\end{appendices}
