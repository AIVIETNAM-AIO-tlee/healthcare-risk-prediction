...
\end{tabular}
\caption{Raw shape, feature-type composition, missingness, and target
positive rate for the three datasets before any preprocessing.}
...
\end{tabular}
\caption{The six most-missing columns in Dataset 1 (raw data, before imputation).}
